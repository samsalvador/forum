...
<body>
	<div id="wrapper">
		...
		<div class="col-sm-10">
		<div class="jumbotron">
		  <h1 class="display-3" class="row text-center">Welcome Visitor!</h1>
		  <p class="lead">This is a simple blog made by PHP.</p>
		  <hr class="my-4">
		  <p class="lead">
		    <a class="btn btn-primary btn-lg" href="blogposts.php" role="button">View my Blog Posts</a>
		  </p>
		</div>
